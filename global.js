        ...
        d3.json("keyboard_data.json").then(function(data) {
            ...
            function updateKeyboard(group) {
                keyboard.forEach((row, i) => {
                    ...
                    row.forEach((key, j) => {
                        ...
                        keyGroup.select('.frequency-text')
                            .text(d3.format(".3%")(frequency));
                    });
                });
            }
            ...
            keyboard.forEach((row, i) => {
                ...
                row.forEach((key, j) => {
                    ...
                    const rect = keyGroup.append("rect")
                        .attr("class", "key")
                        .attr("width", keySize)
                        .attr("height", keySize)
                        .attr("rx", 8);
                    ...
                    const freqText = keyGroup.append("text")
                    ...
                    keyGroup
                        .on("mouseover", function(event) {
                            ...
                            tooltip.transition()
                                .duration(200)
                                .style("opacity", .9);
                            tooltip.html(`Key: ${key.toUpperCase()}<br/>Frequency: ${d3.format(".3%")(data[currentGroup][key.toLowerCase()] || 0)}`)
